...
translator.config(function($translateProvider) {
    $translateProvider.translations('en', {
        ...
        about_find_location: 'Choose a location',
        about_find_a_party: 'Find a party',
        about_create_a_party_strong: 'Want to create your own party ?',
        about_create_a_party: 'You just have to be a game master or be aware of the rules of your game.',
    ...
    $translateProvider.translations('fr', {
        ...
        about_your_desire: 'Exprimez votre envie',
        about_find_location: 'Choisissez votre zone géographique',
        about_find_a_party: 'Trouver un groupe près de chez vous',
        about_create_a_party_strong: 'Vous souhaitez créer un groupe ?',
        about_create_a_party: 'Il vous suffit de connaître un lieu ou d’être Maître du jeu/de connaître les règles correspondantes pour créer une session',
